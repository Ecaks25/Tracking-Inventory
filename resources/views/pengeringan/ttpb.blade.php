@section('title', __('TTPB'))
<x-layouts.app :title="__('TTPB')">

<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">{{ __('TTPB') }}</h5>
    </div>
    <div class="card-body">
        <a href="{{ route('pengeringan.ttpb.create') }}" class="btn btn-primary mb-4">{{ __('Isi TTPB') }}</a>
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>QTY Awal</th>
                        <th>QTY Aktual</th>
                        <th>Qty Loss Pengeringan</th>
                        <th>% Loss Pengeringan</th>
                        <th>Coly</th>
                        <th>Spec</th>
                        <th>Keterangan</th>
                        <th>Aksi</th>
