    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route($role.'.ttpb.store') }}">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <label for="qty_loss" class="form-label">{{ __('Qty Loss Pencucian') }}</label>
                    <input type="number" id="qty_loss" name="qty_loss" class="form-control" />
                </div>
                <div class="col-md-6">
                    <label for="persen_loss" class="form-label">{{ __('% Loss Pencucian') }}</label>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" id="kadar_air" name="kadar_air" class="form-control" />
                </div>
                <div class="col-md-6">
                    <label for="deviasi" class="form-label">{{ __('Deviasi') }}</label>
                    <input type="number" step="0.01" id="deviasi" name="deviasi" class="form-control" />
                </div>
                <div class="col-md-6">
