<nav
  ...
  <div class="layout-menu-toggle navbar-nav align-items-xl-center me-4 me-xl-0">
    <a id="sidebar-toggle" class="nav-item nav-link px-0 me-xl-6" href="javascript:void(0)">
  ...
  <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
    ...
    <ul class="navbar-nav flex-row align-items-center ms-md-auto">
      <li id="zoom-controls" class="nav-item me-3 d-flex align-items-center">
        <button type="button" id="zoom-out" class="btn btn-sm btn-icon btn-outline-secondary me-1">
          <i class="icon-base bx bx-minus icon-md"></i>
        </button>
        <input
          type="range"
          id="zoom-slider"
          ...
          step="10"
          value="100" />
        <button type="button" id="zoom-in" class="btn btn-sm btn-icon btn-outline-secondary ms-1">
          <i class="icon-base bx bx-plus icon-md"></i>
        </button>
        <span id="zoom-percentage" class="ms-2">100%</span>
      </li>
